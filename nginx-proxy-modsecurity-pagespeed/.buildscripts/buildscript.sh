...
if [ "${BUILD}" = "yes" ]; then
    ...
    docker build -t eilandert/nginx-modsecurity3-pagespeed:php5.6 -f ${GITPATH}/nginx-proxy-modsecurity-pagespeed/Dockerfile-php56 ${GITPATH}/nginx-proxy-modsecurity-pagespeed
    docker build -t eilandert/nginx-modsecurity3-pagespeed:php7.2 -f ${GITPATH}/nginx-proxy-modsecurity-pagespeed/Dockerfile-php72 ${GITPATH}/nginx-proxy-modsecurity-pagespeed
    docker build -t eilandert/nginx-modsecurity3-pagespeed:php7.4 -f ${GITPATH}/nginx-proxy-modsecurity-pagespeed/Dockerfile-php74 ${GITPATH}/nginx-proxy-modsecurity-pagespeed
    docker build -t eilandert/nginx-modsecurity3-pagespeed:php8.0 -f ${GITPATH}/nginx-proxy-modsecurity-pagespeed/Dockerfile-php80 ${GITPATH}/nginx-proxy-modsecurity-pagespeed
    docker build -t eilandert/nginx-modsecurity3-pagespeed:multiphp -f ${GITPATH}/nginx-proxy-modsecurity-pagespeed/Dockerfile-multi ${GITPATH}/nginx-proxy-modsecurity-pagespeed
