...
sed -i 's/#TEMPLATE2#/hirsute/'  base/Dockerfile-rolling
...
#hack for ondrej/hirsute
#sed -i s/"\#TEMPLATE3\#"/"echo \"deb \[trusted=yes\] http:\/\/ppa.launchpad.net\/ondrej\/php\/ubuntu\/ groovy main\" > \/etc\/apt\/sources.list.d\/ondrej-ppa.list"/ base/Dockerfile-rolling
#normal operation
