...
#sed -i s/"\#TEMPLATE4\#"/"echo \"deb \[trusted=yes\] http:\/\/deb.myguard.nl\/openssl3\/ \${DIST} main\" > \/etc\/apt\/sources.list.d\/myguard.list"/ nginx-proxy-modsecurity-pagespeed/Dockerfile*
#sed -i s/"\#TEMPLATE5\#"/"echo \"deb \[trusted=yes\] http:\/\/edge.deb.myguard.nl:8888\/apt\/repo-openssl3\/ \${DIST} main\" >> \/etc\/apt\/sources.list.d\/edge.list"/ nginx-proxy-modsecurity-pagespeed/Dockerfile-*
