...
--
-- Host: 10.0.0.101    Database: vimbadmin
-- ------------------------------------------------------
...
CREATE TABLE `directory_entry` (
  ...
  `homePostalAddress` longtext COLLATE utf8_unicode_ci DEFAULT NULL,
  `initials` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
  `jpegPhoto` longtext COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '(DC2Type:object)',
  `labeledURI` longtext COLLATE utf8_unicode_ci DEFAULT NULL,
